(function() {
  ...
  const shayariCollection = [
    {
      title: "💕 Pyaar Ki Baat",
      message: "Tumhari hansi mein chhupa hai mera sukoon,<br>Tumhare saath har pal hai mera jahaan."
    },
    {
      title: "🌹 Dil Ki Dhadkan",
      message: "Tumhare bina zindagi adhuri hai,<br>Tumhare saath har pal puri hai."
    },
    {
      title: "✨ Khwabon Ki Duniya",
      message: "Tumhare saath jeena hai mera sapna,<br>Tumhare bina jeena hai mera dukh."
    },
    {
      title: "💖 Mohabbat Ki Kahani",
      message: "Tumhari aankhon mein main kho jaata hoon,<br>Jaise chandni raat mein taare doob jaate hain."
    },
    {
      title: "🌸 Pyaar Ka Geet",
      message: "Tumhare pyaar mein main jeeta hoon,<br>Tumhare saath main khush hoon."
    },
    {
      title: "💝 Dil Ki Baat",
      message: "Tumhari muskaan mere liye sabse bada tohfa hai,<br>Jo har dard ko bhula deti hai."
    },
    {
      title: "🌺 Pyaar Ki Dua",
      message: "Tumhare liye har roz dua karta hoon,<br>Ki tum hamesha khush raho."
    },
    {
      title: "💕 Dil Ki Awaaz",
      message: "Tumhare saath har pal ek nayi umang hai,<br>Har saans mein tumhari khushboo basi hai."
    },
